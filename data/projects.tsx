export const projects: Project[] = [
  ...
  {
    title: '亚洲金融合作联盟',
    description: '亚洲国家的中小银行及非银行金融机构组成的区域性金融合作组织',
    preview: '/img/project/afca.jpg',
    website: 'http://www.afca.com.cn',
    tags: ['design', 'favorite'],
    type: 'web',
  },
  {
    title: '诺思医疗器械',
    description: '诺思医疗器材制造商',
    preview: '/img/project/medterials.jpg',
    website: 'https://medterials.cn',
    tags: ['design', 'favorite'],
    type: 'web',
  },
  {
